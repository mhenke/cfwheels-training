...
We should add something about when the comment was posted. CFWheels has a really neat helper named @distanceOfTimeInWords@ which takes two dates and creates a text description of their difference like "32 minutes later", "3 months later", and so on. You can use it in your @_comment.cfm@ partial like this:
