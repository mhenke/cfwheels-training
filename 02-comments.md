...
Open the file that the generator created, '/db/migrate/some-timestamp\_creates\_comments\_table.cfc`. Inside the 'self.up' you need to add one line for each of the pieces of data we just brainstormed. It’ll start off with these…
...
Obviously this is expecting a file '/views/articles/\_comment\_form.cfm`, so create the file and add this content for now:
...
This is just like we did it in the Examples. Now we can create a form inside our '\_comment\_form.cfm' partial like this:
...
Change your '\_comment\_form.cfm' so it prints out “Your Name”, “Your Email Address”, “Your URL (optional)”, and “Your Comment”. Then refresh the page and look at the html generated. It should look like this:
