...
The code examples will show both examples when useful.
...
In CFML, cfc is an object. Objects know information, called attributes , and they can do actions, called methods.
