...
In this iteration we'll add the ability to tag articles for organization and navigation. Tagging is similar to some blogs' " Posted Under" feature. For example, if I wrote a blog post about our training, I might tag it as "CFWheels", "Training", and "ColdFusion".
...
That's a pain for since we don't have the @tags.name@ yet. The solution was to augment the relationship with "shortcut". We'll update our relationship now to the Article and Tag classes:
