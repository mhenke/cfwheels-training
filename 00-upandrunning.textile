...
Let's create that view template now. In the left pane of your Eclipse window, expand the @JSBloggers@ project so you can see @views@, then expand @views@. Right-click on the @articles@ folder, select @New@ then @Folder@ and, in the popup, name the folder @Articles@. Next repeat the process, but select @File@ and, in the popup, name the file @index.cfm@
