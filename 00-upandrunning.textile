...
Now you'll see that the @findAll()@ command gave you back an query object holding the one article we created and saved. Go ahead and *create 3 more sample articles* in one request under a method called "moreSamples"wwww.
...
Any additional code we add to the controller must go _between_ the beginning and ending @cfcomponent@ instructions, outside any @cffunction@ instructions.
...
TODO: REDO INTO TABLE TABLE UL/UI
