...
If that's easy, try creating a @delete@ method in your @tags_controller.rb@ and adding a delete link to the tag list. If you do this, change the association in your @tag.rb@ so that it says @has_many :taggings, :dependent => :delete@. That'll prevent orphaned Tagging objects from hanging around.
