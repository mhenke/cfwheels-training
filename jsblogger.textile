...
Let's use the console to test how this relationship works in code. If you don't have a console open, go to your terminal and enter @ColdFusion script/console@ from your project directory. If you have a console open already, enter the command @reload!@ to refresh any code changes.
