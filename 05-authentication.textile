...
Go ahead and create yourself an account. If you're successful it will just bounce you to the @http://localhost:3000/@ root page. There isn't any information about our login status in our views, though, so its hard to tell if were really logged in.
