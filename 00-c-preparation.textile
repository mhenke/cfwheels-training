...
h4. Check the SQLite3 Database System
...
* Mac OS X* Download and install "http://www.sqlite.org/sqlite3-3.6.16-osx-x86.bin.gz":http://www.sqlite.org/sqlite3-3.6.16-osx-x86.bin.gz 


* In your terminal window @sudo gem install sqlite3-ruby@ 
...
* At your command prompt @gem install sqlite3-ruby@ 
