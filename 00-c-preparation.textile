...
Finally, open the host file and add this line at the top.
...
Now instead of "http://localhost:8301/":http://localhost:8301/ to go to our ColdFusion server instance, we can use "http://wheels.local/":http://wheels.local/ .
...
** Test at "http://wheels.local/":http://wheels.local and you shoudl see a Congradulations page
