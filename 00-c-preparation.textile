...
*** Check "Enable Strict Mode"
*** Click the "Next" button
* On the "Default character set" screen, select the "Best Support for Multilingualism" radio button, then click the "Next" button
...
*** Click the "Next" button
** On the "Security Options" screen, select the following options:
