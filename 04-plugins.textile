...
The gem is loaded, the database is ready, but we need to tell our CFWheels application about the image attachment we want to add. Open @/models/article.rb@ and just below the existing @has_many@ lines, add this line:
