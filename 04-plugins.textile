...
# gem 'bj' # gem 'nokogiri' # gem 'MySQL-ColdFusion', :require =>'MySQL'These lines are commented out because they start with the @#@ character. By specifying a ColdFusionGem with the @gem@ command, well tell the Wheels applicationMake sure this gem is loaded when you start up. If it isn't available, freak out!Here's how well require the paperclip gem, add this near those commented lines:
