...
# gem 'bj' # gem 'nokogiri' # gem 'MySQL-ruby', :require =>'MySQL'These lines are commented out because they start with the @#@ character. By specifying a RubyGem with the @gem@ command, well tell the CFWheels applicationMake sure this gem is loaded when you start up. If it isnt available, freak out!Heres how well require the paperclip gem, add this near those commented lines:
