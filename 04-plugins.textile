...
Copy @/views/articles/index.pdf.cfm@ and delete the starting and ending @cfdocument@ instructions. This isn't very DRY but you can fix that later. Refresh and you should get a word document.
